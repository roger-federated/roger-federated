...
During code generation, be concise and efficient. Write plentiful information-dense comments. Please leave code intact as much as possible if it is not necessary to be changed.
